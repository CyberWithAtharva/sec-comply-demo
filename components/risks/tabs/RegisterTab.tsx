        ...
        <div className="space-y-5">
            ...
            <div className="flex items-center justify-between">
                ...
                <Button
                    ...
                    className="h-auto gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold text-sm rounded-xl"
                >
                                        ...
                                        >
                                            <td className="px-5 py-3.5">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="font-medium text-foreground truncate max-w-[260px]" title={risk.title}>
                                                        {risk.title}
                                                    </span>
                                                </div>
                                            ...
                                            <td className="px-5 py-3.5">
                                                {treatment ? (
                                                    ...
                                                    <span className="text-[10px] text-muted-foreground/70 italic">not set</span>
                                                )}
                                            </td>
                                            <td className="px-5 py-3.5">
                                            ...
                                            <td className="px-5 py-3.5">
                                                <div className="flex flex-wrap gap-1">
                                                    ...
                                                    {mappings.length > 3 && (
                                                        <span className="text-[9px] text-muted-foreground">+{mappings.length - 3}</span>
                                                    )}
                                                </div>
                                            </td>
                                        </tr>
...
function SmallSelect({
    ...
    return (
        <select
            ...
            className="px-2 py-2 bg-card/50 border border-border rounded-xl text-xs text-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-500/40"
        >
            {options.map((o, idx) => (
