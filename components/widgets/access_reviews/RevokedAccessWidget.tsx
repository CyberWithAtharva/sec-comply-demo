        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col h-full border border-border/50 relative overflow-hidden">
            <div className="flex items-center justify-between mb-4 relative z-10">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-semibold text-foreground tracking-tight">Access Revocations</h3>
                </div>
            </div>

            <div className="flex-1 flex flex-col justify-center items-center relative z-10 space-y-2">
                <div className="text-5xl font-bold tracking-tighter text-foreground flex items-baseline">
                    124<span className="text-sm font-medium text-muted-foreground ml-2 tracking-normal">this month</span>
                </div>
                ...
                <div className="flex space-x-4 text-xs mt-4">
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-muted-foreground uppercase tracking-widest text-[9px]">Automated</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <span className="text-muted-foreground uppercase tracking-widest text-[9px]">Manual</span>
                    </div>
                </div>
            </div>

            <Button variant="plain" className="w-full mt-4 h-auto py-2.5 space-x-2 bg-red-500/10 hover:bg-red-500/20 text-sm font-medium text-red-400 hover:text-red-400 rounded-lg border border-red-500/20 relative z-10">
