        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col h-full border border-border/50">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-semibold text-foreground tracking-tight">Recent Artifacts</h3>
                </div>
                <div className="relative group">
                    ...
                    <input
                        ...
                        className="bg-card/50 border border-border/50 rounded-lg pl-9 pr-3 py-1.5 text-xs text-muted-foreground focus:outline-none focus:border-indigo-500/50"
                    />
                </div>
            </div>

            <div className="w-full overflow-hidden flex-1 flex flex-col">
                <div className="grid grid-cols-12 gap-4 px-4 pb-2 border-b border-border/80 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                ...
                <div className="flex-1 overflow-y-auto mt-2 space-y-2 no-scrollbar">
                    {artifacts.map((artifact, i) => (
                        <div key={i} className="grid grid-cols-12 gap-4 px-4 py-3 items-center hover:bg-secondary/30 rounded-xl transition-colors border border-transparent hover:border-border/50 cursor-pointer">
                            ...
                            <div className="col-span-2">
                                <span className="text-xs font-mono text-muted-foreground bg-card px-2 py-1 rounded border border-border">{artifact.control}</span>
                            </div>
                            <div className="col-span-2">
                                <span className="text-xs text-muted-foreground font-medium">{artifact.type}</span>
                            </div>
