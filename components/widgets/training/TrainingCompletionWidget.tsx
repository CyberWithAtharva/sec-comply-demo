        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col h-full border border-border/50 relative overflow-hidden">
            <div className="flex items-center justify-between mb-4 relative z-10">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-semibold text-foreground tracking-tight">Company Completion</h3>
                </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-2 gap-3 text-center text-xs relative z-10">
                <div className="bg-card/40 border border-border/50 p-2 rounded-lg flex flex-col items-center justify-center">
                    <ShieldCheck className="w-4 h-4 text-emerald-400 mb-1" />
                    <span className="block text-foreground font-bold text-lg">412</span>
                    <span className="text-muted-foreground uppercase tracking-widest text-[9px]">Trained</span>
                </div>
                <div className="bg-card/40 border border-border/50 p-2 rounded-lg flex flex-col items-center justify-center">
                    <Trophy className="w-4 h-4 text-amber-400 mb-1" />
                    <span className="block text-foreground font-bold text-lg">Top 5%</span>
                    <span className="text-muted-foreground uppercase tracking-widest text-[9px]">Industry Rank</span>
                </div>
            </div>
