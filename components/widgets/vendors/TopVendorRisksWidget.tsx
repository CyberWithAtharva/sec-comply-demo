        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col h-full border border-border/50">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-semibold text-foreground tracking-tight">Critical Watchlist</h3>
                </div>
            </div>
                    ...
                    <div key={idx} className="p-3 bg-card/40 rounded-xl border border-border/50 flex flex-col group hover:bg-secondary/40 transition-colors cursor-pointer">
                        <div className="flex justify-between items-start mb-2">
                            <div className="flex flex-col">
                                <span className="text-sm font-medium text-foreground group-hover:text-indigo-400 transition-colors flex items-center">
                                    {vendor.name}
                                    <ExternalLink className="w-3 h-3 ml-1.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                                </span>
                                <span className="text-[11px] text-muted-foreground">{vendor.service}</span>
                            </div>
                            <span className={cn(
            ...
            <Button variant="link" className="h-auto p-0 hover:no-underline text-xs text-indigo-400 hover:text-indigo-300 mt-4 text-center font-medium">
