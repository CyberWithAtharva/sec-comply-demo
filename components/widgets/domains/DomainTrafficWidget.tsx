        ...
        <div className="glass-panel p-6 rounded-2xl flex flex-col h-full border border-border/50">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-lg font-semibold text-foreground tracking-tight">Request Origins</h3>
                </div>
                <Globe2 className="w-5 h-5 text-muted-foreground/70" />
            </div>

            <div className="flex-1 w-full relative min-h-[180px] rounded-xl overflow-hidden bg-card/40 border border-border/50 flex flex-col items-center justify-center">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-xs pt-4 border-t border-border/50">
                <div className="flex items-center space-x-1.5 bg-secondary/50 px-2 py-1 rounded border border-border">
                    ...
                    <span className="text-muted-foreground">EU Data Centers</span>
                </div>
                <div className="flex items-center space-x-1.5 bg-secondary/50 px-2 py-1 rounded border border-border">
                    <MapPin className="w-3 h-3 text-red-400" />
                    <span className="text-muted-foreground">Anomalous Spike (SA)</span>
                </div>
            </div>
        </div>
    );
