    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Framework Catalog</h1>
            ...
            {total === 0 ? (
                <div className="rounded-2xl border border-border/60 bg-card/30 p-16 text-center">
                    ...
                    <p className="text-muted-foreground font-medium">No frameworks yet</p>
                    <p className="text-sm text-muted-foreground mt-1">Create your first compliance framework to get started.</p>
                    <Button variant="plain"
                        onClick={openCreate}
                        className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-amber-500 hover:bg-amber-400 text-black font-semibold text-sm rounded-xl transition-colors h-auto"
                    >
                        <Plus className="w-4 h-4" />
                        Create framework
                    </Button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {paged.map(fw => {
                            ...
                            return (
                                <div
                                    key={fw.id}
                                    className="group relative rounded-2xl border border-border/60 bg-card/30 hover:bg-secondary/40 hover:border-border/60 transition-all backdrop-blur-sm overflow-hidden"
                                ...
                                >
                                    <Link href={`/admin/frameworks/${fw.id}`} className="block p-5">
                                        ...
                                        <div className="flex items-center justify-between">
                                            {fw.category ? (
                                                <span className="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-secondary/60 text-muted-foreground border border-border/60 uppercase tracking-wider truncate max-w-[60%]">
                                    ...
                                    <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity flex gap-1">
                                        <Button variant="plain"
                                            ...
                                            className="p-1.5 rounded-md bg-secondary/80 hover:bg-secondary text-muted-foreground transition-colors h-auto"
                                        ...
                                        <Button variant="plain"
                                            ...
                                            className="p-1.5 rounded-md bg-red-950/80 hover:bg-red-900 text-red-400 transition-colors disabled:opacity-50 h-auto"
