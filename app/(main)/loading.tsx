    ...
    return (
        <div className="w-full space-y-6 animate-pulse">
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="col-span-2 rounded-xl border border-border bg-card/50 p-5 space-y-3">
                    <div className="h-5 w-36 bg-secondary rounded" />
                    <div className="space-y-2 pt-2">
                        {Array.from({ length: 6 }).map((_, i) => (
                            <div key={i} className="flex items-center gap-3">
                                <div className="h-4 w-4 rounded bg-secondary flex-shrink-0" />
                                <div className="h-4 flex-1 bg-secondary/70 rounded" style={{ width: `${65 + (i % 3) * 10}%` }} />
                                <div className="h-5 w-16 bg-secondary rounded-full flex-shrink-0" />
                            </div>
                        ))}
                    </div>
                </div>
                <div className="rounded-xl border border-border bg-card/50 p-5 space-y-3">
                    ...
                    <div className="h-40 bg-secondary/40 rounded-lg mt-2" />
                    <div className="space-y-2">
